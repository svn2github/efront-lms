...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
    ...
    //array_pop($parts);
    //$str = implode("/", $parts);
    //define('K_PATH_MAIN',$str."/");
    define('K_PATH_MAIN',G_ROOTPATH.'libraries/external/tcpdf/');
	//define ("K_PATH_MAIN", "C:/Programs/xampp/htdocs/efronts/www/tcpdf/");

	/**
	 * url path
	 */
	//define ("K_PATH_URL", implode("/", $parts ));
	define ("K_PATH_URL", G_SERVERNAME.'www/content/');
