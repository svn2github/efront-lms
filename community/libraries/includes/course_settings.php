...
$options['calendar'] = array('image' => '16x16/calendar.png', 'title' => _SCHEDULING, 'link' => basename($_SERVER['PHP_SELF']).'?'.$baseUrl.'&op=course_scheduling', 'selected' => $_GET['op'] != 'course_scheduling' ? false : true);
