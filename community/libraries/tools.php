...
* lesson are returned
*
* @param int $type 0: All events, 1: All educational, 2: Current lesson, 4: Organization profile
            ...
            if ($_SESSION['s_lessons_ID'] != false) {
                ...
                if (G_VERSIONTYPE != 'community') { #cpp#ifndef COMMUNITY
                    if (G_VERSIONTYPE != 'standard') { #cpp#ifndef STANDARD
                        if ($GLOBALS['currentLesson'] -> options['survey'] && (!isset($GLOBALS['currentUser'] -> coreAccess['surveys']) || $GLOBALS['currentUser'] -> coreAccess['surveys'] != 'hidden') && $GLOBALS['configuration']['disable_surveys'] != 1) {
                ...
                if (G_VERSIONTYPE != 'community') { #cpp#ifndef COMMUNITY
	                if ($GLOBALS['currentLesson'] -> options['lessons_timeline'] && ($GLOBALS['configuration']['social_modules_activated'] & SOCIAL_FUNC_LESSON_TIMELINES)) {
