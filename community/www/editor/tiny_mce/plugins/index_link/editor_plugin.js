...
init : function(ed, url) {
			...
			ed.addCommand('mceIndexLink', function() {
				tinyMCE.execInstanceCommand(ed.editorId, 'mceInsertContent', false, '<a href="index.php?index_efront">'+ ed.getLang('index_link.linkdescription') +'</a>');
			});
...
tinymce.PluginManager.add('index_link', tinymce.plugins.IndexLinkPlugin);
})();
