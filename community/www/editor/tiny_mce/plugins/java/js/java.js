var JavaDialog = {
	...
	html +='<table class="mceJava" width="'+width+'" height="'+height+'" rules="rows" frame="box" cellspacing="4" cellpadding="4" border="2" style="border-style: dotted; border-width: 3px;  vertical-align: top; color: rgb(51, 51, 51); background-color: rgb(204, 255, 153);"><tbody><tr><td align="center" valign="center"><applet codebase="'+ codebase +'" code="'+file+ '" width="' + width + '" height="'+ height+ '"/></applet><img src="images/file_types/java.gif" /></td></tr></tbody></table>';
