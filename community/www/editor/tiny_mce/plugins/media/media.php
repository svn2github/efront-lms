							  ...
							  <td>
									<table border="0" cellspacing="0" cellpadding="0">
									  <tr>
										...
										<td>&nbsp;&nbsp;&nbsp;<button type="button" onclick = "generatePreview();">{#media_dlg.preview}</button></td>
									  </tr>
									</table>
								</td>
							</tr>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
							...
							<td colspan="2">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td><input type="checkbox" class="checkbox" id="flv_autostart" name="flv_autostart" onchange="generatePreview();" /></td>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						<tr>
							<td colspan="2">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td><input type="checkbox" class="checkbox" id="wmp_autostart" name="wmp_autostart"  onchange="generatePreview();" /></td>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
							<td colspan="2">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td><input type="checkbox" class="checkbox" id="shockwave_autostart" name="shockwave_autostart" onchange="generatePreview();" /></td>
