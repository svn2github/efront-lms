...
tinymceConfigs["mceEditor"] = {
 ...
 verify_html : false,
 convert_urls : false,
    plugins : "java,asciimath,asciisvg,table,save,advhr,advimage,advlink,style,emotions,inlinepopups,iespell,preview,searchreplace,print,contextmenu,media,paste,fullscreen,template,save_template",
