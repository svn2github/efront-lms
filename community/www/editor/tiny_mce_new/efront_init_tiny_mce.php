...
tinymceConfigs["mceEditor"] = {
 ...
 document_base_url:"'.G_SERVERNAME.'",
    plugins : "autolink,lists,spellchecker,pagebreak,layer,insertdatetime,iframe,noneditable,visualchars,xhtmlxtras,tooltip,Jsvk,java,asciimath,asciisvg,table,save,advhr,advimage,advlink,style,emotions,inlinepopups,iespell,preview,searchreplace,print,contextmenu,media,paste,directionality,fullscreen,template,save_template",
