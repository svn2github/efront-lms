...
This text and the data below appear from Demo module's getLessonSmartyTpl() and module_demo_lessonpanel.tpl file
...
{/capture}
{eF_template_printBlock title = $smarty.const._MODULE_DEMO_DEMODATALESSONCPANEL data = $smarty.capture.t_demo_data_code}
