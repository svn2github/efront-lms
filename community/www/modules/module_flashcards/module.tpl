...
{capture name = "t_module_flashcard_decks_code"}
		<div class = "tabber">
        	<div class = "tabbertab" title = "{$smarty.const._FLASHCARDS_CARDS}">
				{eF_template_printBlock title=$smarty.const._FLASHCARDS_CARDS data=$smarty.capture.t_module_flashcard_cards_list_code image=$T_MODULE_FLASHCARDS_BASELINK|cat:'images/flashcard32.png' absoluteImagePath=1}
            </div>
			<div class = "tabbertab {if $smarty.get.tab == 'options'}tabbertabdefault{/if}"" title = "{$smarty.const._FLASHCARDS_OPTIONS}">
				{eF_template_printBlock title=$smarty.const._FLASHCARDS_OPTIONS data=$smarty.capture.t_module_flashcard_deck_options_code image=$T_MODULE_FLASHCARDS_BASELINK|cat:'images/flashcard32.png' absoluteImagePath=1}
			</div>
		</div>
{/capture}
{eF_template_printBlock title=$smarty.const._FLASHCARDS_DECKS data=$smarty.capture.t_module_flashcard_decks_code image=$T_MODULE_FLASHCARDS_BASELINK|cat:'images/flashcard32.png' absoluteImagePath=1}
{else}
...
{/capture}
{eF_template_printBlock title=$smarty.const._FLASHCARDS_DECKS data=$smarty.capture.t_module_flashcard_decks_list_code image=$T_MODULE_FLASHCARDS_BASELINK|cat:'images/flashcard32.png' absoluteImagePath=1}
{/if}
