...
define("_FUZE_PROF_SCHEDULE_MEETING_PARTICIPANT_NAME","First name");
define("_FUZE_PROF_SCHEDULE_MEETING_PARTICIPANT_SURNAME","Last name");
...
$content .= "<p>Direct link to the meeting: ###MEETING_LINK###</p>";
$content .= "<p>This is an automated email sent to you by: {$email_host} @ {$email_timestamp}<br/>";
$content .= "For further information you may contact the system administrator through the following URL: {$email_contact_address}</p>";
