{capture name="_mod_fm_prof_schedule"}
 ...
 <div>
  <table cellpadding="5" cellspacing="2" style="width:100%;">
   ...
   <tr valign="top">
    ...
    <td>
     {eF_template_html_select_date prefix=starttime_ start_year="+0" end_year="+1" field_order=$T_DATE_FORMATGENERAL} {$smarty.const._TIME}: {html_select_time prefix="starttime_" display_seconds=false}
    </td>
   </tr>
   <tr valign="top">
    <td style="width:125px;">
   ...
   <tr valign="top">
    ...
    <td>
     <table cellpadding="0" cellspacing="0" style="width:100%;">
      <tr>
       <td>
        <input type="checkbox" name="_mod_fm_prof_schedule_form_email" id="_mod_fm_prof_schedule_form_email"/> <label for="_mod_fm_prof_schedule_form_email">{$smarty.const._FUZE_PROF_SCHEDULE_MEETING_SEND_EMAIL}</label>
       </td>
      </tr>
      <tr>
       <td><input type="checkbox" name="_mod_fm_prof_schedule_form_calendar" id="_mod_fm_prof_schedule_form_calendar"/> <label for="_mod_fm_prof_schedule_form_calendar">{$smarty.const._FUZE_PROF_SCHEDULE_MEETING_CALENDAR}</label></td>
      </tr>
      <tr>
       <td style="padding-top:15px;"><input type="button" class="flatButton" id="_mod_fm_prof_schedule_form_btn" name="_mod_fm_prof_schedule_form_btn" value="{$smarty.const._FUZE_PROF_SCHEDULE_MEETING_BTN}" onclick="javascript:_mod_fm_prof_schedule();"/></td>
      </tr>
     </table>
    </td>
   </tr>
...
{eF_template_printBlock title=$smarty.const._FUZE_MEETINGS data=$smarty.capture._mod_fm_prof_schedule image= $T_RSS_MODULE_BASELINK|cat:'images/rss32.png' absoluteImagePath = 1}
   ...
   new Ajax.Request(url, {
    ...
    onSuccess: function(response) {
     ...
     if (response.success) {
      ...
      var url = ''
      url += '{/literal}{$MOD_FM_BASEURL}{literal}&action=meeting_schedule&';
