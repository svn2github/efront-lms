...
class Module_TextMe_SmsGateway_Smsn extends Module_TextMe_SmsGateway {

    private $wsdl_uri = 'https://www.smsn.gr/api/soap/sms.wsdl.php';
    ...
    public function test() {
        ...
        $text = 'This is a test message. Routed by www.smsn.gr.';
