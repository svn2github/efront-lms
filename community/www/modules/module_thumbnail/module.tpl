...
{if $smarty.get.add_thumbnail || $smarty.get.edit_thumbnail}
	...
	{eF_template_printBlock title=$smarty.const._THUMBNAIL_THUMBNAILVIDEODATA data=$smarty.capture.t_insert_thumbnail_code image='32x32/photo.png'}
...
{else}
	...
	{eF_template_printBlock title=$smarty.const._THUMBNAIL_THUMBNAILLIST data=$smarty.capture.t_thumbnail_list_code image='32x32/photo.png'}
{/if}
