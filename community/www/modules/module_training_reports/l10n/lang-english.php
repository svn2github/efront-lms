...
define('_TRAININGREPORTS', 'Training periods report');

define('_TRAININGREPORTS_SELECTREPORT', 'Select report');

define('_TRAININGREPORTS_SEPARATEDBY', 'Group by');
define('_TRAININGREPORTS_WEEKS', 'Weeks');
define('_TRAININGREPORTS_FORTNIGHTS', 'Fortnights');
define('_TRAININGREPORTS_MONTHS', 'Months');
