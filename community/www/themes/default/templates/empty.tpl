	...
	{capture name = 't_cart_form'}
		...
		<div id="cart">
			...
			<tr>
				...
				<a style="cursor:pointer;" onclick = "ajaxPostRemove('{$cartlist.id}', this);"><img src = "images/16x16/shopping_basket_delete.png" alt = "{$smarty.const._REMOVEFROMCART}" title = "{$smarty.const._REMOVEFROMCART}" border = "0"></a>
				</td>
			</tr>
			...
			<tr>
				...
				<a style="cursor:pointer;" onclick = "ajaxPostRemoveAll('', this);"><img src = "images/16x16/shopping_basket_delete.png" alt = "{$smarty.const._REMOVEALLFROMCART}" title = "{$smarty.const._REMOVEALLFROMCART}" border = "0"></a>
				</td>
			</tr>
				...
				<tr class = "oddRowColor">
					...
					<table border = "0" width = "100%">
						...
						<tr class="evenRowColor"><td width="10%"></td>
							<td align="left">
								<div style="margin:1px;"><a style="cursor:pointer;" onclick = "ajaxPost('{$lessons_list->lesson.id}', this);"><img src = "images/16x16/shopping_basket_add.png" alt = "{$smarty.const._ADDTOCART}" title = "{$smarty.const._ADDTOCART}" border = "0"></a> {$smarty.const._ADDTOCART}</div>
								<div style="margin:1px;"><a href=""><img src = "images/16x16/information.png" alt = "{$smarty.const._LESSONINFORMATION}" title = "{$smarty.const._LESSONINFORMATION}" border = "0"></a> {$smarty.const._LESSONINFORMATION}</div>
							</td>
...
{eF_template_printBlock title = $smarty.const._LESSONSDIRECTORY data = $smarty.capture.t_main_capture image = '32x32/catalog.png'}
