...
{capture name = "moduleGlossary"}
	<tr><td class = "moduleCell">
		...
		{/capture}	
		{eF_template_printBlock title = $smarty.const._GLOSSARY data = $smarty.capture.t_glossary_add_code image = '32x32/glossary.png'}
	{else}
...
<!--/tabberajax:tabbertab{$count}-->            		
		...
		{/capture}
            	...
            	{/if}		
		{eF_template_printBlock title = $smarty.const._GLOSSARY data = $smarty.capture.t_glossary_code image = '32x32/glossary.png'}
