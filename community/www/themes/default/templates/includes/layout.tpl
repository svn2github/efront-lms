...
{if $_change_}        
        <tr><td colspan = "3" id = "buttons">
        		<div>
        			<span>
        				<img class = "ajaxHandle" src = "images/32x32/generic.png" alt = "{$smarty.const._RESTOREDEFAULTLAYOUT}" title = "{$smarty.const._RESTOREDEFAULTLAYOUT}" onclick = "if (confirm('{$smarty.const._THISWILLDELETECUSTOMBLOCKS}')) updatePositions(this, true)" />
        			...
        			<span>			
        				<img class = "ajaxHandle" src = "images/32x32/success.png" alt = "{$smarty.const._SAVELAYOUT}" title = "{$smarty.const._SAVELAYOUT}" onclick = "updatePositions(this)">
