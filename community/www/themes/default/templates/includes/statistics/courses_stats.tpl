 ...
 {else}
    <tr>
                 ...
                 <td id = "right">
                        ...
                        <a href = "{$T_BASIC_TYPE}.php?ctg=statistics&option=course&sel_course={$smarty.get.sel_course}&excel=1&group_filter={$smarty.get.group_filter}&branch_filter={$smarty.get.branch_filter}">
                            <img src = "images/file_types/xls.png" title = "{$smarty.const._XLSFORMAT}" alt = "{$smarty.const._XLSFORMAT}" />
                        </a>
                        <a href = "{$T_BASIC_TYPE}.php?ctg=statistics&option=course&sel_course={$smarty.get.sel_course}&pdf=1&group_filter={$smarty.get.group_filter}&branch_filter={$smarty.get.branch_filter}">
