 ...
 {else}
  ...
  <tr>
   ...
   <td id="right">{$smarty.const._EXPORTSTATS}
    <a href="{$smarty.server.PHP_SELF}?ctg=statistics&option=skill&sel_skill={$smarty.get.sel_skill}&group_filter={$smarty.get.group_filter}&excel=skill&branch_filter={$smarty.get.branch_filter}">
     <img src="images/file_types/xls.png" title="{$smarty.const._XLSFORMAT}" alt="{$smarty.const._XLSFORMAT}" /> </a>
    <a href="{$smarty.server.PHP_SELF}?ctg=statistics&option=skill&sel_skill={$smarty.get.sel_skill}&group_filter={$smarty.get.group_filter}&pdf=skill&branch_filter={$smarty.get.branch_filter}">
