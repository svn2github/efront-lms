 ...
 <td class = "filter">
        <select style = "vertical-align:middle" name = "user_filter" onchange = "if (this.options[this.selectedIndex].value != '') document.location='{$smarty.server.PHP_SELF}?ctg=statistics&option={$smarty.get.option}&{if (isset($smarty.get.tab))}&tab={$smarty.get.tab}{/if}&sel_{$smarty.get.option}={$T_STATS_ENTITY_ID}{if (isset($smarty.get.branch_filter))}&branch_filter={$smarty.get.branch_filter}{/if}{if (isset($smarty.get.group_filter))}&group_filter={$smarty.get.group_filter}{/if}{if $smarty.get.job_filter}&job_filter={$smarty.get.job_filter}{/if}{if $smarty.get.subbranches}&subbranches={$smarty.get.subbranches}{/if}&user_filter='+this.options[this.selectedIndex].value+'{$dates_url}';">
        ...
        <select style = "vertical-align:middle" name = "group_filter" onchange = "if (this.options[this.selectedIndex].value != '') document.location='{$smarty.server.PHP_SELF}?ctg=statistics&option={$smarty.get.option}&{if (isset($smarty.get.tab))}&tab={$smarty.get.tab}{/if}&sel_{$smarty.get.option}={$T_STATS_ENTITY_ID}{if (isset($smarty.get.branch_filter))}&branch_filter={$smarty.get.branch_filter}{/if}{if (isset($smarty.get.user_filter))}&user_filter={$smarty.get.user_filter}{/if}{if $smarty.get.job_filter}&job_filter={$smarty.get.job_filter}{/if}{if $smarty.get.subbranches}&subbranches={$smarty.get.subbranches}{/if}&group_filter='+this.options[this.selectedIndex].value+'{$dates_url}';">
