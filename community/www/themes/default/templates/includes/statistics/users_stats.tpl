 ...
 {/capture}
    ...
    {elseif $T_USER_LOGIN != ""}
     {eF_template_printBlock title = "`$smarty.const._REPORTSFORUSER` <span class='innerTableName'>&quot;#filter:login-`$T_USER_LOGIN`#&quot;</span>" data = $smarty.capture.user_statistics image = '32x32/users.png' help = 'Reports'}
    {else}
