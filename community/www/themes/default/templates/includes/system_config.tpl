 ...
 <fieldset class = "fieldsetSeparator">
  ...
  <table class = "configurationSettings">
      <tr><td class = "labelCell">{$smarty.const._EXTERNALLYSIGNUP}:&nbsp;</td>
         ...
         <tr><td class = "labelCell">{$T_SYSTEM_VARIABLES_FORM.apache_authentication.label}:&nbsp;</td>
             <td class = "elementCell">{$T_SYSTEM_VARIABLES_FORM.apache_authentication.html}</td></tr>
