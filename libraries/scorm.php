...
function get_APIFunctions()
{
 ...
 /**
* Πάρε τα δεδομένα του manifest και βάλε τα σε ένα πολυεπίπεδο array
*/
...
/*Φτιάχνει τη δομή των καταλόγων όπως είναι στο περιεχόμενο scorm.*/
...
/*Επιτρέφει έναν πίνακα με τα directories που υπάρχουν μέσα στο όρισμα path*/
...
/**
* H synarthsh afth sympiezei ola ta parapanw se ena arxeio tar.
*/
