...
function smarty_function_eF_template_html_select_date($params, &$smarty)
{
    ...
    if ($display_months) {
        ...
        if (null !== $field_array){
            $month_result .= '"' . $field_array . '[' . $prefix . 'Month'.$instance.']"';
        } else {
            $month_result .= '"' . $prefix . 'Month'.$instance.'"';
        }
        if (null !== $month_size){
    ...
    if ($display_days) {
        ...
        if (null !== $field_array){
            $day_result .= '"' . $field_array . '[' . $prefix.'Day'.$instance.']"';
        } else {
            $day_result .= '"' . $prefix . 'Day'.$instance.'"';
        }
        if (null !== $day_size){
