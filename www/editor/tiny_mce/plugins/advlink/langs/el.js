...
popup_opts : 'Επιλογές',
anchor_names : 'Άγκυρες',
target_same : 'Άνοιγμα στο ίδιο παράθυρο / frame',
target_parent : 'Άνοιγμα στο πατρικό παράθυρο / frame',
target_top : 'Άνοιγμα στο πάνω frame (αντικαθιστά όλα τα frames)',
