...
<div class="title"><?php echo _INSERTHYPERLINK?></div>

<table border="0" style="width: 100%;">
<?php  if ($_SESSION['s_lessons_ID'] != "") { ?>
<TR>
    <TD VALIGN="top" align="left" width="30%"><?php echo _FILE?> :
        <span class="help"><?php echo _SELECTTHEONEYOUWANTASLINK?>.</span>
        <br>
    ...
    <TD VALIGN="top" align="left"><?php echo _UNIT?> :
        <span class="help"><?php echo _SELECTTHEONEYOUWANTAS?> <BR><?php echo _SMALLCAPSHYPERLINK?>.</span>
        <br>
...
<TR>
    <TD VALIGN="top" align="left"><?php echo _FILE?> :
        <span class="help"><?php echo _SELECTTHEONEYOUWANTASLINK?>.</span>
        <br>
