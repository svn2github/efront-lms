...
theme_removeformat_desc : 'παλοιφή μορφοποίησης',
...
theme_code : 'Κώδικας',
theme_samp : 'Δείγμα κώδικα',
theme_dt : 'Ορισμός ',
theme_dd : 'Περιγραφή ορισμού',
...
about_title : 'Σχετικά με τον TinyMCE',
about : 'About',
license : 'Άδεια',
plugins : 'Plugins',
plugin : 'Plugin',
author : 'Δημιουργός',
version : 'Έκδοση',
loaded_plugins : 'Φορτωμένα plugins',
help : 'Βοήθεια',
not_set : '-- Δεν έχει τεθεί --',
close : 'Κλείσιμο',
toolbar_focus : 'Μεταφορά στα tool buttons - Alt+Q, Μεταφορά στον κειμενογράφο - Alt-Z, Μεταφορά στο element path - Alt-X',
invalid_data : 'Λάθος: Εισήχθησαν μη επιτρεπτές τιμές οι οποίες έχουν χρωματιστεί κόκκινες.'
});