var tinyMCE_GZ = {
	settings : {
		...
		languages : 'el,en',
		disk_cache : false,  //for supporting both compress form and muliple languages
...
/*	// MPALTAS FIX: NO REASON FOR DB WHICH MESSES WITH THE URL SINCE WE USE THE base and script location
