...
//	    alert(' '+this.documentURL);
//	    tinyMCE.baseURL = this.documentURL +tinyMCE.baseURL + "/";
            tinyMCE.baseURL = baseHREF + tinyMCE.baseURL + "/";
        }
        ...
        this._def("remove_script_host", false);
...
//      this.xmlEncodeEnts = {'&':'&amp;','"':'&quot;',"'":'&#39;','<':'&lt;','>':'&gt;'};
    ...
    setupContent : function(editor_id) {
        ...
        tinyMCE.importCSS(inst.getDoc(), "css/css_global.php");
